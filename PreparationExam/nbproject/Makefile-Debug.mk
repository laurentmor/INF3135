...
${OBJECTDIR}/src/ex4.4.o: src/ex4.4.c 
	...
	${RM} $@.d
	$(COMPILE.c) -g -Iinclude -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/ex4.4.o src/ex4.4.c

${OBJECTDIR}/src/ex5.3.o: src/ex5.3.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -g -Iinclude -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/ex5.3.o src/ex5.3.c

${OBJECTDIR}/src/exchap7.o: src/exchap7.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -g -Iinclude -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/exchap7.o src/exchap7.c

${OBJECTDIR}/src/exchap8.o: src/exchap8.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -g -Iinclude -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/exchap8.o src/exchap8.c

${OBJECTDIR}/src/exchap9.o: src/exchap9.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -g -Iinclude -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/exchap9.o src/exchap9.c

${OBJECTDIR}/src/exer3.7.o: src/exer3.7.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -g -Iinclude -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/exer3.7.o src/exer3.7.c

${OBJECTDIR}/src/exer4.2.o: src/exer4.2.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -g -Iinclude -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/exer4.2.o src/exer4.2.c

${OBJECTDIR}/src/hello.o: src/hello.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -g -Iinclude -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/hello.o src/hello.c
